...
1. **Criar nova jornada**: Veja [CONTRIBUTING.md](../CONTRIBUTING.md#criando-uma-jornada)
2. **Editar no Studio**: Acesse http://localhost:3000/studio
3. **Ver no Storybook**: Acesse http://localhost:6006
